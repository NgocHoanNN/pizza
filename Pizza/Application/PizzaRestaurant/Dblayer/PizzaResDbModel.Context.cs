...
namespace Dblayer
{
    ...
    public partial class PizzaResDbEntities : DbContext
    {
        public PizzaResDbEntities()
            : base("name=PizzaResDbEntities")
        {
        }
        ...
        public virtual DbSet<StockItemIngredentTable> StockItemIngredentTables { get; set; }
