    ...
    public class DashboardMV
    {
        ...
        public DashboardMV(int? id)
        {
            ...
            if (user.UserDetailTable != null)
            {
                ...
                ProfileMV.ExperienceLevel = user.UserDetailTable.ExperienceLevel;
                ProfileMV.ExperienceLastDegreePhotoPath = user.UserDetailTable.ExperienceLastDegreePhotoPath;
                ProfileMV.ExperienceLastPhotoPath = user.UserDetailTable.ExperienceLastPhotoPath;
            }
            GetUserAddress();
        }
