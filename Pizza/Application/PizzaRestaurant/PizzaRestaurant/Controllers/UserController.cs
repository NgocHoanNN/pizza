...
namespace PizzaRestaurant.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Dashboard(DashboardMV dashboardMV)
        {
            ...
            if (!string.IsNullOrEmpty(dashboardMV.ProfileMV.ExperienceLevel))
            {
                userdetail.ExperienceLevel = dashboardMV.ProfileMV.ExperienceLevel;
                Db.Entry(userdetail).State = System.Data.Entity.EntityState.Modified;
                Db.SaveChanges();
            }
            if (dashboardMV.ProfileMV.EducationLastDegreePhoto != null)
            {
                ...
                if (response)
                {
                    ...
                    if (userdetail == null)
                    {
                        ...
                        userdetail.CreatedBy_UserID = userid;
                        userdetail.UserDetailProvideDate = DateTime.Now;
                        userdetail.ExperienceLastDegreePhotoPath = photo;
                        Db.UserDetailTables.Add(userdetail);
                        Db.SaveChanges();
                    }
                    else
            ...
            if (dashboardMV.ProfileMV.ExperenceLastPhoto != null)
            {
                ...
                if (response)
                {
                    ...
                    if (userdetail == null)
                    {
                        ...
                        userdetail.CreatedBy_UserID = userid;
                        userdetail.UserDetailProvideDate = DateTime.Now;
                        userdetail.ExperienceLastPhotoPath = photo;
                        Db.UserDetailTables.Add(userdetail);
                        Db.SaveChanges();
                    }
                    else
