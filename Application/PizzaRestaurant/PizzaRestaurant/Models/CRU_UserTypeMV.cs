...
namespace PizzaRestaurant.Models
{
    public class CRU_UserTypeMV
    {
        public CRU_UserTypeMV()
        {
            ...
            foreach (var usertype in new PizzaResDbEntities().UserTypeTables.ToList())
            {
        ...
        public CRU_UserTypeMV(int? id)
        {
            ...
            var editusertype = new PizzaResDbEntities().UserTypeTables.Where(u => u.UserTypeID == id).FirstOrDefault();
